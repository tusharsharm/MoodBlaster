...
Confidence threshold preference: Progress to next level when emotion detection reaches 60% confidence.
Multiple face support: Game detects and shows bounding boxes for up to 5 faces simultaneously.
